...
HOUSE_SECTION_PLAIN = {
    "ru": {
        1: ("Кто вы рядом", "как меняется самоощущение, когда вы вместе"),
        2: ("Деньги", "кто тратит, кто копит — и не ссоритесь ли из‑за этого"),
        3: ("Разговоры", "легко болтаете или каждый раз «ты меня не слышишь»"),
        4: ("Дом", "быт, родня и ощущение «своего гнёздышка»"),
        5: ("Романтика", "флирт, свидания, страсть — и кто первый предлагает кино"),
        7: ("Серьёзность", "это «просто встречаемся» или уже про будущее"),
        8: ("Близость", "доверие, страсть и «наши общие деньги»"),
        9: ("Взгляды на жизнь", "куда ехать в отпуск и о чём спорить по вечерам"),
        10: ("Работа и статус", "как пара влияет на карьеру и репутацию"),
    },
    "en": {
