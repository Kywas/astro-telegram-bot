...
def natal_qa_family_keyboard(locale: str, *, part: int) -> InlineKeyboardMarkup:
    ...
    rows = [
        [
            InlineKeyboardButton(
                text=question_button_label(idx, q),
...
def compat_style_picker_keyboard(
    locale: str,
    *,
    current_style: str,
    return_to: str = "menu",
    ...
    plain_mark = "✓ " if style == "plain" else ""
    terms_mark = "✓ " if style == "terms" else ""
    back_data = "nav:compat" if return_to == "menu" else "nav:compat"
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=f"{plain_mark}{t(locale, 'natal_style_plain')}",
                    callback_data=f"compat:style:plain:{return_to}",
                ),
                InlineKeyboardButton(
                    text=f"{terms_mark}{t(locale, 'natal_style_terms')}",
                    callback_data=f"compat:style:terms:{return_to}",
                ),
            ],
            [InlineKeyboardButton(text=t(locale, "back"), callback_data=back_data)],
        ]
...
def prefs_current_skip_keyboard(locale: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t(locale, "prefs_current_keep"),
                    callback_data="prefcurrent:keep",
                )
            ],
