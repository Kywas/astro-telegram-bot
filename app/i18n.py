...
TEXTS = {
    "ru": {
        ...
        "natal_header": "Ведический разбор карты",
        ...
        "btn_natal_qa_popular": "🔥 Популярные вопросы",
        "btn_natal_qa_spheres": "📂 По сферам",
        "btn_natal_qa_family": "💍 Отношение / Брак / Семья",
        "btn_natal_qa_finance": "💼 Финансы / Инвестиции / Карьера",
        "btn_natal_qa_karma": "🪷 Прошлые воплощения / Карма",
        "btn_natal_qa_traits": "✨ Твои изначальные характеристики",
        "btn_natal_qa_lineage": "🌳 Род / Мать / Отец",
        "btn_natal_qa_health": "💪 Здоровье / Тело",
        "btn_natal_qa_purpose": "🎯 Предназначение / Таланты / Реализация",
        "btn_natal_qa_dharma": "🕉️ Духовность / Путь / Дхарма",
        "btn_natal_qa_travel": "✈️ Эмиграция / Путешествия",
        "btn_natal_qa_upaya": "🪬 Гармонизация / Упайи",
        ...
        "natal_qa_free_available": "🎁 Доступен 1 бесплатный вопрос по карте.",
        "natal_qa_free_used_hint": "Бесплатный вопрос использован. Дальнейшие ответы — в Premium.",
        "premium_required_natal_qa": "Бесплатный вопрос по карте уже использован.",
        "premium_required_weekly_qa": "Разборы в еженедельном посте доступны в Premium.",
        ...
        "premium_features": (
            "🌠 Premium — чтобы жить не на автопилоте, а по своему плану.\n\n"
            "🪐 Полная натальная карта: сильные стороны, ресурсы и зоны риска.\n"
            "❓ Личные разборы по карте: вопросы про отношения, деньги, работу, переезды.\n"
            "✨ Гороскоп на неделю и месяц: видеть наперёд, когда лучше усиливать газ, а когда — притормозить.\n"
            "💫 Совместимость без лимита (до 10 партнёров): партнёр, друг, клиент — понимать, где вы совпадаете, а где нет.\n"
            "📬 Недельный гороскоп в авторассылке: чтобы не забывать про себя среди дел.\n"
            "🌙 Лунный календарь и напоминания о фазах: в какие дни проще отпускать, проявляться, начинать.\n"
            "📌 Всё в одном месте, без поиска по десяткам астроблогов."
        ),
        ...
        "channel_publish_usage": "Используй: /channelpublish slug (пример: /channelpublish energy-day)",
        "channel_publish_ok": "✅ Пост «{slug}» опубликован в канале.",
        "channel_publish_fail": "❌ Не удалось опубликовать «{slug}»: {error}",
        "channel_preview_ok": "👀 Превью «{slug}» отправлено админам: {sent}/{total}.",
        "channel_preview_fail": "❌ Превью «{slug}» не удалось: {error}",
    ...
    "en": {
        ...
        "natal_header": "Vedic chart reading",
        ...
        "btn_natal_qa_popular": "🔥 Popular questions",
        "btn_natal_qa_spheres": "📂 By life area",
        "btn_natal_qa_family": "💍 Relationship / Marriage / Family",
        "btn_natal_qa_finance": "💼 Finance / Investments / Career",
        "btn_natal_qa_karma": "🪷 Past Incarnations / Karma",
        "btn_natal_qa_traits": "✨ Your Innate Characteristics",
        "btn_natal_qa_lineage": "🌳 Lineage / Mother / Father",
        "btn_natal_qa_health": "💪 Health / Body",
        "btn_natal_qa_purpose": "🎯 Purpose / Talents / Realization",
        "btn_natal_qa_dharma": "🕉️ Spirituality / Path / Dharma",
        "btn_natal_qa_travel": "✈️ Emigration / Travel",
        "btn_natal_qa_upaya": "🪬 Harmonization / Upayas",
        ...
        "natal_qa_free_available": "🎁 You have 1 free chart question available.",
        "natal_qa_free_used_hint": "Your free question is used. Further answers require Premium.",
        "premium_required_natal_qa": "Your free chart question has already been used.",
        "premium_required_weekly_qa": "Weekly post readings are available in Premium.",
        ...
        "channel_publish_usage": "Use: /channelpublish slug (example: /channelpublish energy-day)",
        "channel_publish_ok": "✅ Post «{slug}» published to the channel.",
        "channel_publish_fail": "❌ Failed to publish «{slug}»: {error}",
        "channel_preview_ok": "👀 Preview «{slug}» sent to admins: {sent}/{total}.",
        "channel_preview_fail": "❌ Preview «{slug}» failed: {error}",
