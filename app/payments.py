    ...
    if settings.payment_provider_token and settings.premium_price_rub > 0:
        options.append(
            PremiumPaymentOption(
                ...
                button_ru=f"💳 {settings.premium_price_rub} ₽",
                button_en=f"💳 {settings.premium_price_rub} ₽",
                panel_ru=f"💳 {settings.premium_price_rub} ₽",
                panel_en=f"💳 {settings.premium_price_rub} ₽",
            )
        )
